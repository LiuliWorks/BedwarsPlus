...
public class FileUtils {
    ...
    public static String loadCFG(String fname,String pluginName,String JarDir){
        if(!new File("./plugins/"+pluginName+"/"+fname).exists()){
            new File(new File("./plugins/"+pluginName+"/"+fname).getPath()).mkdirs();
