...
public class Fireball extends EntityProjectile implements EntityExplosive {
    ...
    public Fireball(FullChunk chunk, CompoundTag nbt) {
        this(chunk, nbt, null);
    }
    ...
    @Override
    public void explode() {
        ExplosionPrimeEvent ev = new ExplosionPrimeEvent(this, 1.5);
